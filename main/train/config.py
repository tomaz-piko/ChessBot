...
class TrainingConfig:
    def __init__(self):
        ...
        self.conv_kernel_initializer = "he_normal" # None reverts to TF default setting
        self.use_bias_on_outputs = False
        self.value_head_filters = 32
        self.value_head_dense = 128
        self.value_head_loss_weight = 0.25
        ...
        self.pb_c_factor = (1.6, 1.25) # Used for full searches
        ...
        self.checkpoint_interval = 30 # Every n cycles 
